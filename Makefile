...
all: crystal crystal_debug  crystal11 crystal11_debug crystal11_vc
roms: crystal crystal_debug crystal11 crystal11_debug
...
pokecrystal_opt         = -Cjv -t PM_CRYSTAL -i BXTD -n 0 -k 01 -l 0x33 -m 0x10 -r 5 -p 0
pokecrystal11_opt       = -Cjv -t PM_CRYSTAL -i BXTD -n 1 -k 01 -l 0x33 -m 0x10 -r 5 -p 0
pokecrystal_debug_opt   = -Cjv -t PM_CRYSTAL -i BXTD -n 0 -k 01 -l 0x33 -m 0x10 -r 5 -p 0
pokecrystal11_debug_opt = -Cjv -t PM_CRYSTAL -i BXTD -n 1 -k 01 -l 0x33 -m 0x10 -r 5 -p 0
pokecrystal11_vc_opt    = -Cjv -t PM_CRYSTAL -i BXTD -n 1 -k 01 -l 0x33 -m 0x10 -r 5 -p 0
